...
class  Nazimabad extends Component {
    constructor() {
        super();
        this.state = {
            date:'',
    ...
    componentWillMount() {
        ...
        firebase.database().ref('parking/nazimabad').on(
            'value', snap => {
               this.state.slotArray =  Object.values(snap.val())
...
componentWillMount() {
    ...
    handleOpen = (index) => {
        ...
        firebase.database().ref(`parking/nazimabad/slot${index}`).on(
            'value', snap => {
      ...
      dialogSubmitButton = () => {
        ...
        firebase.database().ref(`parking/nazimabad/slot${this.state.slotNumber}`).set(this.state.TimeSaveArray)
